...
|--------------------------------------------------------------------------
*/
$config['website_name'] = 'StickyDiscounts';
$config['webmaster_email'] = 'admin@stickydiscounts.com';
$config['noreply_email'] = 'no_reply@stickydiscounts.com';
/*
|--------------------------------------------------------------------------
| Security settings
|
...
$config['recaptcha_public_key'] = '6LfIT-kSAAAAAAXyCbb2n40iGDRgAxGuaghzWzt0';
$config['recaptcha_private_key'] = '6LfIT-kSAAAAAP8I2emkNOR0O62iQnazgVh_OeHa';
...
$config['main_site_name'] = 'StickyDiscounts';
$config['main_site_url'] = 'http://StickyDiscounts.com/';
