       ...
       <script>
                    $(document).ready(function(){
                        $("#business_edit_form_user").submit(function(){
                            ...
                            $.ajax({
                            url:'<?php echo site_url('store/update/'.$details[0]["uid"]); ?>',
                            dataType:'json',
                            type:'POST',
                            data:values,
            ...
            $(document).ready(function(){
                ...
                if($.trim($('#username_edit_user').val()).length <= 3){
                   ...
                   $('#username_edit_user').css('border','1px solid #cccccc');  
                            ...
                            $.ajax({
                            url:'<?php echo site_url('store/update_account_details/'.$details[0]["uid"]); ?>',
                            dataType:'json',
                            type:'POST',
                            data:values,
                            success:function(result){
           ...
           <form name="business_edit_form_password_user" id="business_edit_form_password_user">                
            ...
            $(document).ready(function(){
                ...
                $('#business_edit_form_password_loader_user').fadeIn();
                            ...
                            $.ajax({
                            url:'<?php echo site_url('store/update_password/'.$details[0]["uid"]); ?>',
                            dataType:'json',
                            type:'POST',
                            data:values,
                            success:function(result){
