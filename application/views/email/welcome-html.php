...
<?php echo $site_name; ?> Adminstrator has added you as Store owner on <?php echo $site_name; ?>. We listed your sign in details below, make sure you keep them safe.<br />
