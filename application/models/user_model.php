...
class user_model extends CI_Model
{
    ...
    public function view_user($user_id)
    {
         $data = array('users.id' => $user_id);
            ...
            $this->db->select('users.id,users.email,users.banned,users.ban_reason,users.last_login,users.last_ip,users.created,user_profiles.first_name,user_profiles.last_name');
            $this->db->where($data);
